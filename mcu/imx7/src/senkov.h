...
#define ADC_OUTPUT_CURRENT     0 // (Iвых) дискрет 10мА для 15кА
#define ADC_OUTPUT_VOLTAGE     1 // (Vвых) дискрет 10мV для 40V
#define ADC_DCLINK_VOLTAGE     2 // (V dclink) дискрет 1 мВ
#define ADC_CHANNEL_3          3
#define ADC_SYS_TEMP           4 // (T sys) дискрет 0.1град
#define ADC_CPU_TEMP           5 // (T cpu) дискрет 0.1град
